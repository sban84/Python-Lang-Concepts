...
# way 2. best way to create and initialize
phonebook = {
    "bob": 7387,
    "alice": 3719,
    "jack": 7052,
...
# add / update new items , remember this
...
a second parameter.
default=None is optional , if we don't pass then key error for non existent passed key. """
