"""NOTE: Very qimportant code , This is same as Object_Eqality_Python.sorting_user_objects.py
But here we just wanted to see how a file can call another python module from diff dir.
To do that we need to add parent folder in PYTHONPATH as env variable in .bash_profile
